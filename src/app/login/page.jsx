...
const Page = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center  px-4 py-5 lg:py-20 relative glass bg-[#4f2e08]">
      <div className="flex flex-col bg-none lg:flex-row w-full max-w-6xl rounded-sm  overflow-hidden gap-3">
        ...
        <div className="flex bg-gradient-to-r from-red-400 via-red-700 to-amber-800 text-white flex-col items-center justify-center p-8 md:w-1/2 rounded-b-full  lg:rounded-tl-full  logo h-72 md:h-auto">   
          ...
          <Link href={"/enroll"}> <button className="border border-white px-6 py-2 rounded-full hover:bg-white hover:text-blue-500 transition">
            Register
                  ...
                  <label className="text-2xl text-[#000000]" htmlFor="email">Email</label> <br />
               ...
               <label className="text-[#000000] font-normal text-2xl" htmlFor="password">Password</label> <br />
              ...
              <button
                 type="submit"
                 className="w-full btn bg-[#6f420c] text-white py-3 rounded-md hover:bg-[#b19263] transition mb-4"
               >
                 Login
               </button>
